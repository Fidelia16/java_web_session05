...
@ComponentScan(basePackages = {"com.session05"})
public class AppConfig {
    ...
    public DataSource dataSource() {
        ...
        dataSource.setUrl("jdbc:mysql://localhost:3306/session05");
        dataSource.setUsername("root");
        dataSource.setPassword("16122002");
        return dataSource;
    }
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        entityManagerFactory.setPackagesToScan("com.session05.Model");
